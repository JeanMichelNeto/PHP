                ...
                <div class="">
                    <div class="card mt-5">
                        <div class="card-title">
                            <h3 class="bg-success text-white text-center py-3">CADASTRAR INCIDENTES</h3>
                        </div>
                        <div class="form-row">

                            <form action="update_prob.php?ID=<?php echo $EquipID ?>" method="post">
                                ...
                                <input type="text" class="form-control mb-2" placeholder=" Data Incidente " name="dataprob">
                                </div>

                                <div class="form-group col-md-7">
                                <label>Solução</label>
                                <input type="text" class="form-control mb-2" placeholder="Solução" name="solucao" rows="4">
                                </div>

                                <div class="form-group col-md-3">
                                <label>Status Problema</label>
                                <input type="text" class="form-control mb-2" placeholder="Status Problema" name="status_prob" rows="4">
                                ...
                                <br>
                                    ...
                                    <button class="btn btn-primary" name="update">Cadastrar</button>
...
<br/>
    <div class="container">
        ...
        <tr> 
          ...
          <th scope="col">DATA E HORA DO PROBLEMA</th>
        ...
        <?php
        $result_auditoria = "SELECT * FROM auditoria WHERE identificador = '$EquipID' and nomeacao = 'CADASTROU PROBLEMA'";
