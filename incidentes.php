                    ...
                    <div class="card mt-5">
                        ...
                        <div class="form-row">
                            ...
                            <form action="update_inc.php?ID=<?php echo $EquipID ?>" method="post">
                                ...
                                <input type="text" class="form-control" placeholder="Incidentes" name="incidentes">
                                </div>

                                <div class="form-group col-md-2">
                                <label>Data Incidente</label>
                                <input type="text" class="form-control mb-2" placeholder=" Data Incidente " name="datainc">
                                </div>
                                ...
                                <label>Status Incidente</label>
                                <input type="text" class="form-control mb-2" placeholder="Status Incidente" name="status_prob" rows="4">
...
<br/>
    <div class="container">
        ...
        <?php
        $result_auditoria = "SELECT * FROM auditoria WHERE identificador = '$EquipID' and nomeacao = 'CADASTROU INCIDENTE'";
