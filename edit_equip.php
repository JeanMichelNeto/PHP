...
<html lang="pt-br">
    ...
    <body>
      <div class="container">
        <h4 align="center">Pesquisar Equipamento</h4>
        <form class="form-inline" method="post" action="pesquisar.php?edit=" align="center">
          <div class="form-group mb-2">
          <div class="form-group mx-sm-3 mb-2">
            <label for="inputPassword2" class="sr-only">Equipamento</label>
            <input type="text" class="form-control" id="inputPassword2" placeholder="Nome do Equipamento" name="nome">
          </div>
      ...
      <div class="container">
        ...
        while($row_equip = mysqli_fetch_assoc($resultado_equip)){
              ...
              echo "<td>" . $row_equip['categoria'] . "</td>";
              echo "<td>" . $row_equip['tipo'] . "</td>";
              echo "<td>" . $row_equip['garantia'] . "</td>";
              echo "<td>" . $row_equip['proprietario'] . "</td>";
              echo "<td>" . $row_equip['licenca'] . "</td>";

              echo '<td><a href="edita_equipamento.php?edit='.$row_equip['idequipamento'].'""><i class="fas fa-pen"></i></td>';
              echo '<td><a href="delete_equip.php?del='.$row_equip['idequipamento'].'""><i class="material-icons">delete</i></td>';
              echo "</tr>";
        }
