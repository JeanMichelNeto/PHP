...
<html lang="pt-br">
    ...
    <body>
        ...
        <form class="form-inline" method="post" action="pesquisar_equip.php?edit=" align="center">
          <div class="form-group mb-2">
          <div class="form-group mx-sm-3 mb-2">
            <label for="inputPassword2" class="sr-only">Equipamento</label>
            <input type="text" class="form-control" id="inputPassword2" placeholder="Digite o Nome ou N° de Série" name="nome">
          </div>
        ...
        while($row_equip = mysqli_fetch_assoc($resultado_equip)){
              ...
              echo '<td><a href="config_ecs.php?edit='.$row_equip['idequipamento'].'""><i class="material-icons">engineering</i></td>';
              echo "</tr>";
        }
