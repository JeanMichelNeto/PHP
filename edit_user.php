...
<html lang="pt-br">
    ...
    <body>
        ...
        while($row_user = mysqli_fetch_assoc($resultado_user)){
              ...
              echo "<tr>";
              echo "<td>" . $row_user['idusuario'] . "</td>"; 
              echo "<td>" . $row_user['nome'] . "</td>";
              echo "<td>" . $row_user['usuario'] . "</td>";
              echo "<td>" . $row_user['data_cadastro'] . "</td>";
              echo '<td><a href="edita.php?edit='.$row_user['idusuario'].'""><i class="fas fa-pen"></i></td>';
              echo '<td><a href="delete.php?del='.$row_user['idusuario'].'""><i class="material-icons">delete</i></td>';
              echo "</tr>";
        }
