...
<html lang="pt-br">
    ...
    <body>
        <div class="container">
        <h4 align="center">Pesquisar Incidentes</h4>
        
        <form class="form-inline" method="post" action="pesquisar_incidente.php?edit=" align="center">
          <div class="form-group mb-2 col">
          <div class="form-group mx-sm-3 mb-2">
            <input type="text" class="form-control" placeholder="Digite o Nome ou Incidente" name="nome">
          </div>
        ...
        <tr> 
          ...
          <th scope="col">Cadastrar Incidentes</th>
        </tr>
        </thead>
        <tbody>
        ...
        while($row_equip = mysqli_fetch_assoc($resultado_equip)){
              ...
              echo "<td>" . $row_equip['incidentes'] . "</td>";
              ...
              echo '<td><a href="incidentes.php?edit='.$row_equip['idequipamento'].'""><i class="material-icons">add_box</i></td>';
              echo "</tr>";
        }
