...
<html lang="pt-br">
    ...
    <body>
    <div class="container">
            <h4 align="center">Solução de Problemas</h4>
        
        <form class="form-inline" method="post" action="pesquisar_base.php?edit=" align="center">
    ...
    <div class="container">
        ...
        <?php
        $result_auditoria = "SELECT * FROM auditoria WHERE nomeacao = 'CADASTROU PROBLEMA' OR nomeacao ='CADASTROU INCIDENTE'";
